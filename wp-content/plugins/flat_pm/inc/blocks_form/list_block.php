<div class="flat_pm_wrap">
	<h1>Ваши блоки рекламы <?php if(!flat_do_some()){ ?> - <a href="http://wp-pro.online/" target="_blank">Купить <span>PRO</span> версию</a><?php } ?></h1>
	<div class="list_block">
		<div class="row_panel">
			<a href="<?php echo get_site_url(); ?>/wp-admin/admin.php?page=add_blocks_form" class="add_block_new">Добавить новый блок</a>
		...
		<div class="row_cat">
			<a href="<?php echo get_site_url(); ?>/wp-admin/admin.php?page=blocks_form" class="cat_flat_pm active">
			...
			?>
			<a href="<?php echo get_site_url(); ?>/wp-admin/admin.php?page=blocks_form&block_cat_ID=<?php echo $term->term_id; ?>" class="cat_flat_pm" data-id="<?php echo $term->term_id; ?>">
