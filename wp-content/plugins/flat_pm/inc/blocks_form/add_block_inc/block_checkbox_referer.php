<div class="block_checkbox_referer">
	<div class="flat_settings">
		<div class="item_geo_block">
			<input type="checkbox" name="referer_check_setting" id="referer_check_setting">
		...
		<div class="item_geo_block">
			...
			<div class="float_left">
				...
				<textarea name="flat_referer_enabled" id="flat_referer_enabled" placeholder="Например: google.com"></textarea>
			</div>
			<div class="float_right">
				<h3 style="text-align:center">С каких referer'ов <span>не</span> показывать</h3>
				<textarea name="flat_referer_disabled" id="flat_referer_disabled" placeholder="Например: google.com"></textarea>
			</div>
